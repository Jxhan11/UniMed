...
class SearchWithSuggestionsPage extends StatefulWidget {
  ...
  @override
  State<SearchWithSuggestionsPage> createState() => _SearchWithSuggestionsPageState();
}
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: PoggiesM3List(
                  onTapTile: (){print("tile is tapped");},
                  ctx: context,
                  itemNames: ["example1","example2","example3","example4","example5","example6"],
                  leadingIcons: [
                Icon(Icons.search_rounded, color: Theme.of(context).brightness ==
                  Brightness.dark
                  ? Colors.white
                  : Colors.black,),
                Icon(Icons.search_rounded, color: Theme.of(context).brightness ==
                ...
                Icon(Icons.search_rounded, color: Theme.of(context).brightness ==
                  ...
                  trailingIcons: [
                Icon(Icons.close, color: Theme.of(context).brightness ==
                    Brightness.dark
                    ? Colors.white
                    : Colors.black,),
                Icon(Icons.close, color: Theme.of(context).brightness ==
                ...
                Icon(Icons.close, color: Theme.of(context).brightness ==
                  ...
                  theTrailingAction: (){print("cross is pressed");}
              ),
            ),
          )
        ],
