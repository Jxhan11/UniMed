...
final List<InsuranceSeries>data = [
  ...
  InsuranceSeries(
    rating: Text('5') ,
    insuranceName:Text('Basic Health Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text("Covers doctor's visits, lab tests, and preventive care.	",style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('7k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
  InsuranceSeries(
    rating: Text('2') ,
    insuranceName:Text('Silver Health Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text('Covers basic healthcare plus prescription drugs and some specialist care.',style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('14k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
  InsuranceSeries(
    rating: Text('1') ,
    insuranceName:Text('Gold Health Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text('Covers everything in the silver plan plus dental and vision care.',style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('21k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
  InsuranceSeries(
    rating: Text('5') ,
    insuranceName:Text('Platinum Health Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text('Covers everything in the gold plan plus alternative therapies like acupuncture and chiropractic.',style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('28k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
  InsuranceSeries(
    rating: Text('5') ,
    insuranceName:Text('Family Health Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text('Covers a family of four with basic healthcare and additional coverage for children.',style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('35k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
  InsuranceSeries(
    rating: Text('5') ,
    insuranceName:Text('Essential Care Plan',style: TextStyle(fontFamily: "PSL",fontSize: 20),) ,
    info: Text("Covers doctor's visits, basic diagnostic tests, and emergency care.",style: TextStyle(fontFamily: "PSXL",fontSize: 15),),
    price: Text('6k/month',style: TextStyle(fontFamily: "PSXL",fontSize: 15)),
  ),
];
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              title: Text('Insurance Policies',style: TextStyle(fontFamily: "PSL",fontSize: 22,letterSpacing: 0,color: Theme.of(context).brightness == Brightness.dark? LBoxFill:DBoxFill)),
            ),
            SliverToBoxAdapter(
